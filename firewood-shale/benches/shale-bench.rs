...
use rand::Rng;
use firewood_shale::{compact::CompactSpaceHeader, MemStore, MummyObj, ObjPtr, PlainMem};
...
fn serialize(b: &mut Bencher) {
    ...
    b.iter(|| {
        ...
        let _compact_header =
            MummyObj::ptr_to_obj(&m, compact_header_obj, firewood_shale::compact::CompactHeader::MSIZE)
                .unwrap();
    });
}
