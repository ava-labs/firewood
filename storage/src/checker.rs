...
mod test {
    ...
    use crate::nodestore::{FreeArea, FreeLists, NodeStoreHeader, area_size_to_index};
    ...
    fn test_traverse_correct_freelist() {
        ...
        for (area_index, area_size) in area_sizes.iter().enumerate() {
            ...
            for _ in 0..num_free_areas {
                ...
                write_free_area(&nodestore, free_area, *area_size, high_watermark);
        ...
        // write header
        write_header(&nodestore, None, high_watermark, free_list);
