...
impl SeededRng {
    ...
    pub fn from_random() -> Self {
        let seed = rand::rngs::SysRng
            .try_next_u64()
            .expect("OS RNG should never fail");
        eprintln!("Seed {seed}: to rerun with this data, export {ENV}={seed}");
        Self::new(seed)
    }
    ...
    /// Convenience method for [`rand::RngExt::random`] but with a reference and
    ...
    {
        rand::RngExt::random(&mut &*self)
    }

    /// Convenience method for [`rand::RngExt::random_range`] but with a reference
    ...
    {
        rand::RngExt::random_range(&mut &*self, range)
    }
}
