...
impl Historical {
    /// Create a new historical [ReadLinearStore]
    ...
    /// Reparent this linearstore to a new parent. This is a new method because we may want
    /// to make reparenting not use any locks in some cases
