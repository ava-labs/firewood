...
pub fn diff_merkle_iterator<'a, T, U>(
    ...
    start_key: Key,
) -> Result<impl Iterator<Item = Result<BatchOp<Key, Value>, FileIoError>> + 'a, FileIoError>
where
...
mod tests {
    use crate::{
        ...
        proofs::{
            diff::DiffMerkleNodeStream, diff_merkle_iterator, diff_merkle_iterator_without_hash,
        },
