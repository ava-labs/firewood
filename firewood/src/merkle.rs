            ...
            *new_root_children
            ...
            let new_root_value = if let Some(&new_leaf_child_index) = path_overlap.unique_b.first()
            {
                ...
                *new_root_children
                ...
                // The new root branch node is at `key` and has `value`.
                Some(value)
            };
            ...
            Node::Branch(last_node_branch) => {
                ...
                match &*child_node {
                    Node::Branch(child_branch) => {
                        ...
                        *child_branch_parent.mut_child(path_overlap.unique_a[0]) =
                    ...
                    Node::Leaf(child_leaf) => {
                        ...
                        let Some(key_child_index) = path_overlap.unique_b.first() else {
                            ...
                            *new_branch.mut_child(path_overlap.unique_a[0]) = Some(child_addr);
