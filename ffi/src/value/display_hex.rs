...
mod tests {
    ...
    #[test_case(firewood_storage::TrieHash::default_root_hash(firewood_storage::NodeHashAlgorithm::Ethereum).as_deref().expect("ethereum empty root hash"), "56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421", None; "empty rlp hash")]
    #[test_case(firewood_storage::TrieHash::default_root_hash(firewood_storage::NodeHashAlgorithm::Ethereum).as_deref().expect("ethereum empty root hash"), "56e81f171bcc55a6ff8345e692c0f86e... (16 remaining bytes)", Some(16); "empty rlp hash with precision")]
