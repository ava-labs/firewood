...
use firewood::{EthHash, HashMode, MerkleDbHash};
use firewood::{
...
impl DatabaseHandle {
    ...
    fn empty_root_hash(&self) -> Option<HashKey> {
        match self.db.node_hash_algorithm() {
            firewood::NodeHashAlgorithm::Ethereum => EthHash::default_root_hash(),
            firewood::NodeHashAlgorithm::MerkleDB => MerkleDbHash::default_root_hash(),
        }
    }
