...
typedef void<FileBacked> Database;
 ...
 *
 */
struct Value fwd_batch(Database *db,
                       size_t nkeys,
 ...
 *
 */
Database *fwd_create_db(struct CreateOrOpenArgs args);
 ...
 */
struct Value fwd_get(Database *db, struct Value key);
 ...
 *
 */
Database *fwd_open_db(struct CreateOrOpenArgs args);
 ...
 */
struct Value fwd_root_hash(Database *db);
