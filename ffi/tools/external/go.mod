module github.com/ava-labs/firewood/ffi/tools/external
...
//
// Add `-modfile=ffi/tools/external/go.mod` to `go` commands to use this file e.g.
//
// - Add or update a tool
//   - go get -tool -modfile=ffi/tools/external/go.mod github.com/my/dep/@[version]
//
// - Run a tool
//   - go tool -modfile=ffi/tools/external/go.mod [tool] [args]
